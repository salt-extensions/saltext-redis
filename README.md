...
The saltext-redis project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-redis.git
...
* Writing blog posts
* Sharing your experiences using Salt + Redis
  on social media
